...
//The code simply consists of an internal dictionary (associative array) with parameter 
//name (key) and related value; 
//the add method allows appending new parameters, 
//while toXml method - by calling the recursive function SOAPClientParameters._serialize - 
//provides XML serialization for SOAP request (see SOAPClient._sendSoapRequest):
...
//Let's define the SOAPClient class, 
//which can only contain static methods in order to allow async calls, 
//and the only "public" method within this class: SOAPClient.invoke
function SOAPClient() {}
...
//SOAPClient.invoke method interface is described above; 
//our implementation checks whether the call is 
//async (call result will be passed to the callback method) or 
//sync (call result will be directly returned). 
//The call to the Web Service begins by invoking SOAPClient._loadWsdl method:
