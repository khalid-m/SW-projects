...
11. In order to start SWARD WEb service it is necessary to change the content of 
the file WebamosSoapBindingImpl.java with the content of the file SWARD_WebamosSoapBindingImpl.java.
...
13. Start the the Amos II Name Server
      start_server.cmd

   NOTICE this procedure starts an Amos II nameserver and a peer.
...
14. Start SWARD server by completing the commands
	swardWS.cmd
	register("WEB-AMOS");
	listen();
...
=============================== Client side of the SWARD web service ===============================
