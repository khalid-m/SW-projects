...
public class SwatmWSSoapBindingImpl implements swatmWS.SwatmWS{

    private Connection theConnection;
    private String dbServer="WEB-SWATM";
    private boolean initialized = false;
    private java.util.Map opRegistry = new java.util.HashMap();
    
    public SwatmWSSoapBindingImpl(){
	...
	Scan theScan=theConnection.execute("select TM_operations_descr();");
	while (!theScan.eos()){
