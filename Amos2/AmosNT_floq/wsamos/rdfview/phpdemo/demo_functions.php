...
/*Function that displays the query form where the user cna query SWARD or SWATM*/
	function query_form($servername, $filef, $qcont, $l1, $l2)
	{
...
*/
		...
		echo "<textarea name=\"querycont\" cols=\"100\" rows=\"15\" color=\"yellow\">",$qcont,"</textarea></p>\n";
...
//			$scan = amos_call($con,$qlan,$system,$querycont);
 ...
 AND ?val1 =~ '%move%'";
	...
	//SPARQL queries for SWATM
		$sparqlschemasw="SELECT ?bs1 ?sa1 FROM <http://user.it.uu.se/~udbl/software/swatm/egovdemo.xtm> WHERE{ ?t1 <http://udbl2.it.uu.se/swatm#BASENAMETOPIC> ?bnt1. ?bnt1 <http://udbl2.it.uu.se/swatm#BASENAMESTRING> ?bs1. ?bnt1 <http://udbl2.it.uu.se/swatm#SCOPEBASENAME> ?s1. ?s1 <http://udbl2.it.uu.se/swatm#IDTOPIC> 'systemId2'. ?t1 <http://udbl2.it.uu.se/swatm#SUBJECTADDRESS> ?sa1. ?t1 <http://udbl2.it.uu.se/swatm#INSTANCEOFTOPIC> ?t2. ?t2 <http://udbl2.it.uu.se/swatm#BASENAMETOPIC> ?bnt2. ?bnt2 <http://udbl2.it.uu.se/swatm#BASENAMESTRING>  'Default address data'.}";
