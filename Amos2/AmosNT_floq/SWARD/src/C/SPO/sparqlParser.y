 ...
 * $Revision: 1.3 $ $Date: 2007/11/27 13:09:54 $
 * $State: Exp $ $Locker:  $
 *
 ...
 * Revision 1.3  2007/11/27 13:09:54  petrini
 * *** empty log message ***
 *
 * Revision 1.2  2007/11/23 13:44:02  petrini
...
PrimaryExpression: BrackettedExpression
								...
								| BuiltInCall
										{$<id>$=$<id>1;}
								| IRIrefOrFunction
										{$<id>$=new_list_and_merge(mk_str("uri(\""),$<id>1,mk_str("\")"),T_LST_END);}
								| RDFLiteral
										{$<id>$=$<id>1;}
								| NumericLiteral
									{$<id>$=$<id>1;}
