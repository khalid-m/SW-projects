...
/**
 * Utilities to represent any scan as an HTML table. There are some methods
 * at the end of the class that handle HTTP requests - using them IS THE
 * WRONG WAY! They are left only for compatibility with Dominik's IssueTracking
 * application. Instead of using those, one should use beans as in the
 * Course Manager app.
 *
 ...
 * $State: Exp $ $Locker:  $
 * </DD></DT></DL>
 * @author  (c) 2003 Dominik Businger, Timour Katchaounov, UDBL
 * @version $Revision: 1.2 $, $Date: 2003/12/07 20:19:00 $
 */
