...
public class AmosException extends Exception {
  ...
  /**
    * Holds the Amos II error number.
    * The basic error numbers can be viewed in the ..\..\C\storage.h C-header
    * file.
    */
  public int errno;
  ...
  /**
    * Preferred constructor in Java.
    * Raises new Amos II exception.
    */
  ...
  /**
    * Constructor called from C. Creates internal AmosException when
    * Amos II exception occured in C.
    * theErrorMessage is the error message to be printed in Java
    * The Amos error message is constructed from the error number ErrNo.
    * If ErrNo == -1 there is specific Amos error message.
    */
  ...
  /**
    ...
    */
  private static String AmosErrorMessage(int ErrNo, Oid ErrorForm, String AmosMsg)
  {
     String formstr;

     if(ErrorForm==null) formstr=null;
     else
     {
        formstr = ErrorForm.toAmosString();
        if(formstr.equals("NIL")) formstr=null;
     }
     if(ErrNo>0)
     {
        if(formstr==null)
