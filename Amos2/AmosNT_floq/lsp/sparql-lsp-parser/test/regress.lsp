...
(checkequal 
 ...
 ((sparql "LOAD('data/sparql.10.1.ttl',true)") nil)
 ((sorttuples (osql "sparql(:q10_1);")) 
...
; ((osql "sparql(:q_expr2);") '((#("TITLE 1" "10")))) ;TODO: detect and check semibound variables in FILTER expressions! 
 ...
 ((sparql "LOAD('data/dawg.extracted-examples.data-6.1.ttl',true)") nil)
 ((sorttuples (osql "sparql(:q_6_1);")) 
  (sorttuples '((#("SPARQL Query Language Tutorial")) 
		(#("SPARQL")) 
		(#("SPARQL Protocol Tutorial")) 
		(#("SPARQL (updated)")))))
 ((sorttuples (osql "sparql(:q_6_1_r1);")) 
  (sorttuples '((#("SPARQL Query Language Tutorial" nil)) 
		(#("SPARQL" nil)) 
		(#(nil "SPARQL Protocol Tutorial")) 
		(#(nil "SPARQL (updated)")))))
