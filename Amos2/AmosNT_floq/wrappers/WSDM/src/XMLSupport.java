...
public class XMLSupport
{
    ...
    */
    public static Tuple outputString(Document doc) throws AmosException 
    {  
	...
	List  nextallChildren = firstchild.getChildren();
	Iterator i = nextallChildren.iterator();
	Tuple childvec= new Tuple(nextallChildren.size());
        int cvindex=0;
	try
	    {
            	while(i.hasNext())
			...
			if (tempi.hasNext())
			    ...
			    childvec.setElem(cvindex,child.getValue());
			cvindex++;	 
		    }
