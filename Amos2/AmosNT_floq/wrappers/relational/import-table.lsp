...
;;; $Revision: 1.41 $ $Date: 2013/05/01 15:35:27 $
;;; $State: Exp $ $Locker:  $
;;;
...
;;; Revision 1.41  2013/05/01 15:35:27  minzh812
...
;;;
;;; Revision 1.40  2013/01/04 13:59:32  torer
;;; Core cluster function of external relation queryable from SQL
;;;
;;; Revision 1.38  2013/01/03 21:23:44  torer
;;; import-table() makes CC function SQL queryable
;;;
;;; Revision 1.37  2012/10/23 15:07:18  minzh812
...
(defglobal _sql-namespace_ t 
  "Make relational core cluster functions SQL views")
...
(defun make-relational-core-cluster-fn-name (entity-name &optional fnname)
  "Makes a relational core cluster function name out of the typename and the
   name of a propery function if one is specified.
   The argument, relation-name, can be the name of a mapped type or a mapped
   property function."
  (cond ((not _sql-namespace_);; Old CC function names
	 (make-core-cluster-fn-name entity-name fnname))
	(fnname
	 (pack "SQL:" entity-name fnname))
	(t (pack "SQL:" entity-name))))
