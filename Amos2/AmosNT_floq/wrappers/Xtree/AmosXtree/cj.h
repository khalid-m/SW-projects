...
#define JAVA_METHOD_EXTRACT 1
#define JAVA_METHOD_DISPLAY 2
...
extern int cjProxyExec(int methodIndex, cjObject_t *pProxy, jobject inData, jobject *pOutData);
extern int cjFreeObject(cjJVM_t *pJVM, jobject object);

// Proxy Test
extern int cjProxyExecString(int methodIndex, cjObject_t *pProxy, char *inData, char *outData);
