...
{
   {"<init>", "()V", NULL},
   {"extract", "(Ljava/lang/Object;)Ljava/lang/Object;", NULL},
   {"display", "(Ljava/lang/Object;)Ljava/lang/Object;", NULL},
};
...
int cjProxyExec(int methodIndex, cjObject_t *pProxy, jobject data, jobject *pOutData)
{
   return callProxyMethod(pProxy, data, pOutData, methodIndex);
}
...
int cjProxyExecString(int methodIndex, cjObject_t *pProxy, char *inData, char *outData)
{
   long jret = 0;
   int rc = CJ_ERR_SUCCESS;
   cjClass_t *pClass = pProxy->clazz;
   ...
   if (rc == CJ_ERR_SUCCESS)
   {
      rc = cjProxyExec(methodIndex, pProxy, instring, &outobject);
   }
