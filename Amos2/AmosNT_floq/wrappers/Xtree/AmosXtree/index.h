...
typedef oidtype(*index_creator)(bindtype env, oidtype indhdr,unsigned int size);
...
typedef int (*mapxtree_function)(bindtype,oidtype,oidtype,oidtype,void *);

EXTERN void map_xtree(bindtype env, oidtype indhdr, oidtype ht,
                   mapxtree_function f, void *x);
    /* Iterate over keys in hash table ht applying C function fn(key,val,xa) */
extern oidtype memberfn(bindtype env, oidtype x, oidtype y);
extern oidtype removefn(bindtype env, oidtype x, oidtype y);
