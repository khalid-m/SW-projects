...
public class populateSchema
{
    ...
    public String[][] basictype = new String[45][2];
    String schemaname;
    String function,inarg,outarg,select,from,where;
				...
				if(operElem != null && operElem instanceof SOAPOperation )
					...
					if(headerElem != null && headerElem instanceof SOAPHeader )
						...
						Message shMsg = findSoapHeader(wsdlDef,soapHeader.getMessage().getLocalPart());
							buildMessageText(shMsg,"soapheader");
					
						//psch+="set encodingstyle(:"+schemaname+"op"+opindex+")='"+encodingStyle+"';\n";
						//psch+="set namespace(:"+schemaname+"op"+opindex+")='"+soapBody.getNamespaceURI()+"';\n";
					    }
					else
					    psch+="add soapheader(:"+schemaname+"op"+opindex+")={};\n";
		       ...
		       if (wsdlTypes!=null)
			   {
			       ...
			       if(xmlType != null )
				   {
				       ...
				       if (xmlType.getName()!=null)
					   {
						   ...
						   {
						       /*psch+="set mappedtype(:"+schemaname+"e"+tempelementindex+")='"+findbasictype(((SimpleType)xmlType.getBaseType()).getName())+"';\n";*/
						       psch+="set wsdltype(:"+schemaname+"e"+tempelementindex+")='"+xmlType.getName()+"';\n";
						       psch+="set wsmedtype(:"+schemaname+"e"+tempelementindex+")='"+findbasictype(xmlType.getName())+"';\n";
						   ...
						   {
						       psch+="set wsdltype(:"+schemaname+"e"+tempelementindex+")='"+xmlType.getName()+"';\n";
						       psch+="set wsmedtype(:"+schemaname+"e"+tempelementindex+")='"+""+"';\n";
					   ...
					   {
					       psch+="set wsdltype(:"+schemaname+"e"+tempelementindex+")='"+""+"';\n";
					       psch+="set wsmedtype(:"+schemaname+"e"+tempelementindex+")='"+""+"';\n";
					   ...
					   {
					      psch+="set minoccurs(:"+schemaname+"e"+tempelementindex +")="+"'1'"+";\n"; 
					      psch+="set maxoccurs(:"+schemaname+"e"+tempelementindex+")="+"'-1'"+";\n"; 	
					   }
				       else
					   {
					       psch+="set minoccurs(:"+schemaname+"e"+tempelementindex +")="+"'1'"+";\n"; 
					   ...
					   {
					       //System.out.println(" testing  "+part.getElementName().getLocalPart());
					...
					if (part.getElementName()!=null)
					    ...
					    psch+="set name(:"+schemaname+"e"+tempelementindex+")='"+partName+"';\n";
					//	System.out.println("test" + partName);
					psch+="set wsdltype(:"+schemaname+"e"+tempelementindex+")='"+part.getTypeName().getLocalPart()+"';\n";
					psch+="set wsmedtype(:"+schemaname+"e"+tempelementindex+")='"+findbasictype(part.getTypeName().getLocalPart())+"';\n";
		...
		Enumeration groupEnum = group.enumerate();
		 while (groupEnum.hasMoreElements())
			 ...
			 Structure item = (Structure)groupEnum.nextElement();
				...
				//System.out.println("xmlType "+ elementDecl.getName());
				if (xmlType != null)
				    {
					//System.out.println(" testing complex  "+elementDecl.getName());
					    ...
					    psch+="set minoccurs(:"+schemaname+"e"+prefixele+Integer.toString(eindex)+")="+"'"+group.getParticle(particleIndex).getMinOccurs()+"'"+";\n"; 
					    psch+="set maxoccurs(:"+schemaname+"e"+prefixele+Integer.toString(eindex)+")="+"'"+group.getParticle(particleIndex).getMaxOccurs()+"'"+";\n";
					    

                                           if (xmlType.getName()!=null)
					       {
						   psch+="set wsdltype(:"+schemaname+"e"+prefixele+Integer.toString(eindex)+")='"+xmlType.getName()+"';\n";
						   psch+="set wsmedtype(:"+schemaname+"e"+prefixele+Integer.toString(eindex)+")='"+findbasictype(xmlType.getName())+"';\n";
					       }
					    else
						
						{
						    psch+="set wsdltype(:"+schemaname+"e"+prefixele+Integer.toString(eindex)+")='"+""+"';\n";
						    psch+="set wsmedtype(:"+schemaname+"e"+prefixele+Integer.toString(eindex)+")='"+""+"';\n";
						}
