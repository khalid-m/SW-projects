...
public class XMLSupport
{
	...
	if (checkstr.equalsIgnoreCase(outelement))
		...
		if (sb_no_of_children==1)
			...
			tpl=new Tuple(1);
			tpl.setElem(0,(webserviceResponse1(bodyElement,output)).getOidElem(0));
		    }
		else
		    {
			...
			if (no_of_children==1)
				...
				if (bodyElement.hasChildNodes())
					...
					if (!(name.equalsIgnoreCase(childstr)))
					    dummyele=findElement(sbeindex-2,output);
					String elename;
					...
					//System.out.println(output.getStringElem(1)+" ### "+ output.getStringElem(2)+"  "+ output.getStringElem(3)+"   "+(bodyElement.getElementName()).getLocalName()+ "  "+ elename);
					s = theConnection.callFunction("Operation.charstring.subelements->integer",etpl);
					if (!s.eos())
					    {
						//System.out.println(elename+" "+(s.getRow()).getIntElem(0));
						if (!((((s.getRow()).getIntElem(0))==1)&& (maxOccurs(celename,output))))
						    mtpl.setElem(0,getSoapElement(bodyElement,output).getOidElem(0));
						else
						   mtpl.setElem(0,getSoapElement(bodyElement,output)); 
					...
					while (sbeindex>=0)
						...
						if (sbeindex==sbindex)
							...
							String tempele=findElement(sbeindex,output);
							if (maxOccurs(tempele,output))
							    {
								
								Tuple ttpl= new Tuple(1);
								ttpl.setElem(0,temptpl);
								temptpl.setElem(0,(makeRecord(tempele,ttpl,output)).getOidElem(0));
							    }
							else
							    temptpl.setElem(0,(makeRecord(tempele,temptpl,output)).getOidElem(0));
						    }
						sbeindex=sbeindex-2;
					    }	
			    ...
			    {
				//System.out.println("testing more elements1 "+no_of_children);
				while(sei.hasNext())
				    {
					
					//System.out.println("testing more elements1 "+(bodyElement.getElementName()).getLocalName());
					sbeindex=sbindex;
					temptpl= new Tuple(1);
					if (iterval>0) 
					    bodyElement = (SOAPBodyElement)sei.next();
					...
					if (bodyElement.hasChildNodes())
						...
						tpl.setElem(tplindex,temptpl.getOidElem(0));
						tplindex++;
						//System.out.println(" test tpl "+tplindex);
						iterval++;
					    }
    ...
    public static Tuple webserviceResponse1(SOAPBodyElement sb, Tuple output) throws SOAPException,AmosException
    {  
	//theConnection = new Connection(""); 
	int seiind=0;
	Scan s;
	Tuple vtpl= new Tuple(1);
	Tuple mtpl= new Tuple(1);
	//Tuple etpl= new Tuple(4);
	
	//SOAPBody sb=response.getSOAPBody();
	Iterator sei=sb.getChildElements();
	int no_of_children=(sb.getChildNodes()).getLength();
	Tuple tpl = new Tuple((sb.getChildNodes()).getLength());
	int tplindex=0;
	/*etpl.setElem(0,output.getStringElem(1));
	etpl.setElem(1,output.getStringElem(2));
	etpl.setElem(2,output.getStringElem(3));
	etpl.setElem(3,(sb.getElementName()).getLocalName());
	//System.out.println(output.getStringElem(1)+"  "+ output.getStringElem(2)+"  "+ output.getStringElem(3)+"   ");
	s = theConnection.callFunction("charstring.charstring.charstring.charstring.subelements->integer",etpl);
	tpl=new Tuple((s.getRow()).getIntElem(0));*/
	...
	if (!sei.hasNext())
		...
		while (sei.hasNext())
			...
			SOAPBodyElement bodyElement = (SOAPBodyElement)sei.next();
			//System.out.println("testwhile >>> "+(bodyElement.getElementName()).getLocalName());
			...
			if (bodyElement.hasChildNodes())
				...
				if (maxOccurs(celename,output))
				    {
					//System.out.println("test feng " + celename);
					mtpl.setElem(0, getSoapElement(bodyElement,output));
					tpl.setElem(tplindex,(makeRecord((bodyElement.getElementName()).getLocalName(),mtpl,output)).getOidElem(0));
					//tpl.setElem(tplindex,(getSoapElement(bodyElement,output)).getOidElem(0));
				    }
				else
				    {
					//System.out.println("test feng1 ");
					//Oid m=(getSoapElement(bodyElement,output)).getOidElem(0);
   ...
   public static Tuple getSoapElement(SOAPBodyElement sbe, Tuple output) throws SOAPException,AmosException
	...
	int no_of_children=(sbe.getChildNodes()).getLength();
	...
	int iterval=0;
	//System.out.println(" getSoapElement success"+(sbe.getChildNodes()).getLength());
	...
	//System.out.println(output.getStringElem(1)+"  "+ output.getStringElem(2)+"  "+ output.getStringElem(3)+"   "+(bodyElement.getElementName()).getLocalName()+ "  "+ elename);
	s = theConnection.callFunction("Operation.charstring.subelements->integer",etpl);
	//System.out.println("hi "+(s.getRow()).getIntElem(0));
	if (!s.eos())
	    {
		//System.out.println(elename+" "+(s.getRow()).getIntElem(0));
		if (!((((s.getRow()).getIntElem(0))==1)&& (maxOccurs((bodyElement.getElementName()).getLocalName(),output))))
		    no_of_children=1;
	    }
	else
	    {
	...
	//System.out.println((bodyElement.getElementName()).getLocalName()+" "+(s.getRow()).getIntElem(0)+"  "+subelements);
	...
	if (!sei.hasNext())
		...
		//System.out.println("test 111234");
		...
		if (subelements)
			...
			String celename=(cbodyElement.getElementName()).getLocalName();
			//System.out.println("test "+cbodyElement.getNodeType());
			...
			if (maxOccurs(celename,output))
				...
				if (no_of_children==1)
				    {
					if (seiind==0)
					    tpl.setElem(0,(makeRecord((bodyElement.getElementName()).getLocalName(),tplresult,output)).getOidElem(0));
					else
					    tpl.setElem(0,(putRecord(tpl,(bodyElement.getElementName()).getLocalName(),tplresult,output)).getOidElem(0));
				    }
				else
				    {
					tpl.setElem(tplindex,(makeRecord((bodyElement.getElementName()).getLocalName(),tplresult,output)).getOidElem(0));
				...
				if (no_of_children==1)
				    {
					if (seiind==0)
					    tpl.setElem(0,(makeRecord((bodyElement.getElementName()).getLocalName(),getSoapElement(bodyElement,output),output)).getOidElem(0));
					else
					    tpl.setElem(0,(putRecord(tpl,(bodyElement.getElementName()).getLocalName(),getSoapElement(bodyElement,output),output)).getOidElem(0));
				    }
				else
				    {
					tpl.setElem(tplindex,(makeRecord((bodyElement.getElementName()).getLocalName(),getSoapElement(bodyElement,output),output)).getOidElem(0));
		    ...
		    {
			//System.out.println("test 222221111");
			...
			//System.out.println(" testing "+valuecsei);
			if (no_of_children==1)
			    {
				if (seiind==0)
				    {
					...
					tpl.setElem(tplindex,(makeRecord(elename, vtpl,output)).getOidElem(0));
						...
						//System.out.println(tpl.getStringElem(0));
				    }
				else
				    {
					...
					tpl.setElem(tplindex,(putRecord(tpl,elename, vtpl,output)).getOidElem(0)); 
		...
		while (sei.hasNext())
			...
			//System.out.println(no_of_children+" soap element "+(bodyElement.getElementName()).getLocalName());
			if ((bodyElement.getChildNodes()).getLength()>1)
			    {
				Iterator csei=bodyElement.getChildElements();
				SOAPBodyElement cbodyElement = (SOAPBodyElement)csei.next();
				...
				if (maxOccurs(celename,output))
					...
					if (no_of_children==1)
						...
						if (seiind==0)
						    ...
						    {
							//	System.out.println(" put test 10");
							tpl.setElem(0,(putRecord(tpl,(bodyElement.getElementName()).getLocalName(),tplresult,output)).getOidElem(0));
							//System.out.println(" put test 00");
						    }
					    }
					else
					    {
						//System.out.println(" put test 101111");
						tpl.setElem(tplindex,(makeRecord((bodyElement.getElementName()).getLocalName(),tplresult,output)).getOidElem(0));
						tplindex++;
					    }
					seiind++;
					...
					if (no_of_children==1)
						...
						if (seiind==0)
						    ...
						    {
							//	System.out.println(" put test 0");
							tpl.setElem(0,(putRecord(tpl,(bodyElement.getElementName()).getLocalName(),getSoapElement(bodyElement,output),output)).getOidElem(0));
							//System.out.println(" put test 1");
						    }
					    }
					else
					    {
				...
				if (no_of_children==1)
					...
					if (seiind==0)
						...
						if (valuecsei!=null)
						    ...
						    vtpl.setElem(0,""); 
						//System.out.println(no_of_children+" name1 "+valuecsei);
	...
	//Tuple resulttpl= new Tuple(1);
	//resulttpl.setElem(0,tpl);
	//System.out.println(" testing "+tpl.getStringElem(0));
	return tpl;
    }
	...
	if (type.equalsIgnoreCase("-1"))
	    mo=true;
	//System.out.println(name+" tttttt  "+mo); 
	return mo;
