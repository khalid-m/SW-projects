...
// @(#) $Revision: 1.1 $ $Source: /it/project/fo/udbl/CVSRoot/AmosNT/wrappers/trie/SCSQ-trie/Judy-1.0.5/src/JudyCommon/JudyTables.c,v $
...
FUNCTION int main()
{
    ...
    fprintf(fd,"// @(#) From generation tool: $Revision: 1.1 $ $Source: /it/project/fo/udbl/CVSRoot/AmosNT/wrappers/trie/SCSQ-trie/Judy-1.0.5/src/JudyCommon/JudyTables.c,v $\n");
    fprintf(fd,"//\n\n");
