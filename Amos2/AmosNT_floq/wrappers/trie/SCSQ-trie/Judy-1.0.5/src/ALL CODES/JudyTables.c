...
// @(#) $Revision: 1.1 $ $Source: /it/project/fo/udbl/CVSRoot/AmosNT/wrappers/trie/SCSQ-trie/Judy-1.0.5/src/ALL\040CODES/JudyTables.c,v $
...
FUNCTION int main()
{
    ...
    fprintf(fd,"// @(#) From generation tool: $Revision: 1.1 $ $Source: /it/project/fo/udbl/CVSRoot/AmosNT/wrappers/trie/SCSQ-trie/Judy-1.0.5/src/ALL\040CODES/JudyTables.c,v $\n");
    fprintf(fd,"//\n\n");
