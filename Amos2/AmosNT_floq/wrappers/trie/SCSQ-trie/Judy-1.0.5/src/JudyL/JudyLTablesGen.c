...
// @(#) $Revision: 1.4 $ $Source: /it/project/fo/udbl/CVSRoot/AmosNT/wrappers/trie/SCSQ-trie/Judy-1.0.5/src/JudyL/JudyLTablesGen.c,v $
...
FUNCTION int main()
{
    ...
    fprintf(fd,"// @(#) From generation tool: $Revision: 1.4 $ $Source: /it/project/fo/udbl/CVSRoot/AmosNT/wrappers/trie/SCSQ-trie/Judy-1.0.5/src/JudyL/JudyLTablesGen.c,v $\n");
    fprintf(fd,"//\n\n");
