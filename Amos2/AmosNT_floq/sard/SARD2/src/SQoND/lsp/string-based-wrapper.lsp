...
(osql "
create function rdf:insert(Charstring s, Charstring p, Charstring o) -> Boolean
  as add DEF() = (s,p,o);
")
...
(defun get-blank-in-DEF (x)
  (getfunction (car (getobject (getfunctionnamed 'TermInDEF) 'resolvents)) (list x))) ;MAYBE: add < >
