...
;;; $Revision: 1.2 $ $Date: 2013/08/19 13:43:26 $
;;; $State: Exp $ $Locker:  $
;;;
;;; Description: SparQL stream parser
;;; =============================================================
;;; $Log: sparql-stream-parser.lsp,v $
;;; Revision 1.2  2013/08/19 13:43:26  silvias
;;; Load file path update
;;;
;;; Revision 1.1  2013/08/09 14:26:40  silvias
;;; *** empty log message ***
;;;
...
;;  (load "../../lsp/grm/parse-utils.lsp"))
  (with-directory (concat (getenv "AMOS_HOME") "/lsp/grm/")
		     ...
		     (cond ((string= nextch ":")
			   ...
			   ((member 
			     ...
			     '("BASE" "PREFIX" "SELECT" "CONSTRUCT" "DESCRIBE" "ASK" "ORDER" 
			       ...
			       "REDUCED" "FROM" "NAMED" 
			       "WHERE" "GRAPH" "OPTIONAL" "UNION" "FILTER"
			       "LANGMATCHES" "SAMETERM" "TRUE" "FALSE" "AS" "BIND" 
