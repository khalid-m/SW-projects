...
# ---------------------------------------------------------------------------
PROJECT = demo.exe
OBJFILES = demo.obj amosdemo.obj
RESFILES = 
DEFFILE =
RESDEPEN = $(RESFILES)
...
CFLAG2 =
CFLAG3 =
PFLAGS = -U$(BCB)\projects;$(BCB)\lib\obj;$(BCB)\lib;$(DEBUGLIBPATH) \
...
LFLAGS = -L$(BCB)\projects;$(BCB)\lib\obj;$(BCB)\lib;$(DEBUGLIBPATH) -ap -Tpe -x -v
IFLAGS =
LINKER = ilink32
# ---------------------------------------------------------------------------
