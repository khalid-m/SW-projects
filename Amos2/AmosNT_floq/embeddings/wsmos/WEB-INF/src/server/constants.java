...
public interface constants {
    ...
    //public static final String ServiceNameDefault = "Webamos";
    public static final String ServiceNameDefault = "WSMED";
	public static final String DBName = "wsmos";
	public static final String port = "8082";
     
    public static final String ServletDefault = "/wsmed/service/WSMEDServlet";
