...
# ADD CPP /nologo /MD /W3 /GX /ZI /Od /I "$(PYTHON_HOME)\Include" /I "$(PYTHON_HOME)\Lib\site-packages\numpy\core\include\numpy" /I "$(AMOS_HOME)\C" /I "$(AMOS_HOME)\system\include" /I "$(AMOS_HOME)\embeddings\Python\include" /D "WIN32" /D "DEBUG" /D "_CONSOLE" /D "_MBCS" /D "_USRDLL" /D "PYTHONDLL_EXPORTS" /FR /YX /FD /c
# ADD BASE MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0x804 /d "NDEBUG"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib Ws2_32.lib amos2.lib /nologo /dll /incremental:yes /debug /machine:I386 /out:"../../../bin/amos2.pyd" /libpath:"$(PYTHON_HOME)\libs" /libpath:"$(AMOS_HOME)\bin" /libpath:"$(AMOS_HOME)\embeddings\Python\libs" /libpath:""..\..\..\C""
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=set pythonpath=$(AMOS_HOME)\bin
