...
# ADD CPP /nologo /MD /W3 /GX /ZI /Od /I "$(PYTHON_HOME)\Include" /I "$(PYTHON_HOME)\Lib\site-packages\numpy\core\include\numpy" /I "$(AMOS_HOME)\C" /I "$(AMOS_HOME)\system\include" /I "$(AMOS_HOME)\embeddings\Python\callout\include" /D "WIN32" /D "DEBUG" /D "_CONSOLE" /D "_MBCS" /D "PYTHONDLL_EXPORTS" /FR /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib Ws2_32.lib amos2.lib /nologo /subsystem:console /incremental:yes /debug /machine:I386 /out:"../bin/pyamos2.exe" /pdbtype:sept /libpath:"$(PYTHON_HOME)\libs" /libpath:"$(AMOS_HOME)\bin" /libpath:"$(AMOS_HOME)\embeddings\Python\callout\libs"
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds="$(AMOS_HOME)\embeddings\Python\callout\bin\pyamos2" "$(AMOS_HOME)\bin\amos2.dmp" "$(AMOS_HOME)\embeddings\Python\callout\osql\init.osql" -o "save '$(AMOS_HOME)\embeddings\Python\callout\bin\pyamos2.dmp'; quit;"
