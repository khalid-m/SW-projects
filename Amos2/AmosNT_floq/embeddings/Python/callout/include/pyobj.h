 ...
 * $RCSfile: pyobj.h,v $
 * $Revision: 1.7 $ $Date: 2011/04/28 18:27:13 $
 * $State: Exp $ $Locker:  $
 *
...
oidtype pyobj_to_oid(bindtype, PyObject *);   /* Convert python object to amos object */
PyObject *oid_to_pyobj(oidtype);    /* Convert amos object to python object */
