function create_onclick(){
  ...
  var regSucc = window.showModalDialog('CREATE.html',myObject,'dialogWidth:800px; dialogHeight:600px; center:Yes; resizable: Yes; help: No;');
                }

function deploy_onclick(){
  var myObject = new Object();
  var regSucc = window.showModalDialog('DEPLOY.html',myObject,'dialogWidth:800px; dialogHeight:600px; center:Yes; resizable: Yes; help: No;');
                }

        
function execute_onclick(){    
   var myObject = new Object();
   var regSucc = window.showModalDialog('EXECUTE.html',myObject,'dialogWidth:800px; dialogHeight:600px; center:Yes; resizable: Yes; help: No;');
                }
